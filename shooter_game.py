...
game_font_ = pygame.font.Font(None, 30)
...
alien_image = pygame.image.load('img/alien.png')
...
while game_is_running:
    ...
    if rocket_was_fired:
        ...
        game_score_text = game_font_.render(f"Your score is {game_score}", True, 'lightgreen')
    ...
    if rocket_was_fired and\
            ...
            alien_y < rocket_y + alien_height - rocket_height:
        rocket_was_fired = False
        alien_x, alien_y = randint(0, screen_width - alien_width), 0
        alien_speed += ALIEN_STEP / 2
        game_score += 1

game_over_text = game_font.render("Game Over", True, 'lightgreen')
